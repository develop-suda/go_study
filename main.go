...
import (
	// "github.com/nansystem/sample-go/my"
	"my"
	"log"
	"net/http"
	"strconv"
...
// db variable.
var dbDriver = "mysql"
var dbName = "root:secret@tcp(localhost:3306)/mysql_go?charset=utf8&parseTime=true&loc=Asia%2FTokyo"
